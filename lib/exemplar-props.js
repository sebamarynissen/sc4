...
const props = module.exports = {
	...
	0x2c8f8746: "Exemplar Category",
	0x499afa38: "Construction Time",
...
// Invert the props as well so that we map string names to hex values as well.
for (let hex in props) {
	props[props[hex]] = hex;
}