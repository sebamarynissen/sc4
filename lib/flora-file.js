...
class FloraFile {
	...
	// ## *bgen(opts)
	*bgen(opts) {
		for (let flora of this.flora) {
			yield* flora.bgen(opts);
		}
	}
...
module.exports = FloraFile;

// # Flora
// Represents a single flora item.
class Flora {
