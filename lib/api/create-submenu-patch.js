...
// # createMenuPatch(menu, globs, options = {})
export default async function createMenuPatch(menu, globs, options = {}) {

	// We'll first find the files to read in by globbing.
	...
	if (options.save) {
		...
		logger.info(chalk.green(`Saved to ${outputPath}`));
	}
	return dbpf;
