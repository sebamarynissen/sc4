...
exports.refs = async function(opts) {
	...
	// interested in.
	let queries = {
		"Lot": FileType.LotFile,
		"Building": FileType.BuildingFile,
		"Texture": FileType.BaseTextureFile,
		"Prop": FileType.PropFile
	};
	...
	opts.info(`Searching ${ Math.round(10000*refs.length / oLength)/100}% of the refs`);
	let start = new Date();
