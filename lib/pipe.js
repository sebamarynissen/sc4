...
class Pipe extends Type(FileType.PipeFile) {
	...
	constructor(opts) {
		...
		this.arrays = [[], [], [], [], []];
		this.unknown.dword(0x00000000);
		repeat(3, () => this.unknown.float(0));
		this.x4 = 0;
		repeat(3, () => this.unknown.float(0));
		this.y4 = 0;
		repeat(3, () => this.unknown.float(0));
		this.z4 = 0;
		repeat(4, () => this.unknown.float(0));
		this.unknown.dword(0x00000000);
		this.unknown.dword(0x00000000);
	...
	parse(rs) {
		...
		this.unknown.dword(rs.dword());
		repeat(3, () => this.unknown.float(rs.float()));
		this.x4 = rs.float();
		repeat(3, () => this.unknown.float(rs.float()));
		this.y4 = rs.float();
		repeat(3, () => this.unknown.float(rs.float()));
		this.z4 = rs.float();
		repeat(4, () => this.unknown.float(rs.float()));
		this.unknown.dword(rs.dword());
		this.unknown.dword(rs.dword());
	...
	toBuffer() {
		...
		ws.dword(unknown());
		repeat(3, () => ws.float(unknown()));
		ws.float(this.x4);
		repeat(3, () => ws.float(unknown()));
		ws.float(this.y4);
		repeat(3, () => ws.float(unknown()));
		ws.float(this.z4);
		repeat(4, () => ws.float(unknown()));
		ws.dword(unknown());
		ws.dword(unknown());
		ws.bool(unknown());
		ws.bool(unknown());
