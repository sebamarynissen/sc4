...
const NAMES = require('./exemplar-props.js');
const FileType = require('./file-types.js');
const LotObject = require('./lot-object.js');
const { makeEnum, invert, hex } = require('sc4/utils');
...
class Exemplar {
	...
	// ## constructor(opts = {})
	constructor(opts = {}) {
		this.id = opts.id || 'EQZB1###';
		this.parent = opts.parent || [0, 0, 0];
	...
	addProperty(id, value, typeHint = 'Uint32') {
		...
		let prop = new Property(id, Type[type] || type, value);
