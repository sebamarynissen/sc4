...
const registerFileTypes = require('./register-file-types.js');
const TYPES = require('./file-types');
const Stream = require('./stream');
const crc32 = require('./crc');
const { cClass } = require('./enums');
...
class Entry {
	...
	get isArrayType() {
		return Array.isArray(DBPF.FileTypes[this.type]);
	}
	...
	get fileConstructor() {
		...
		if (Array.isArray(Constructor)) return Constructor[0];
